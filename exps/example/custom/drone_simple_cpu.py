...
class Exp(MyExp):
    def __init__(self):
        ...
        self.max_epoch = 5  # Stop after 5 epochs
        self.data_num_workers = 0  # IMPORTANT: Set to 0 for CPU/Mac to avoid multiprocessing issues
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False, legacy=False):
        """
        Override to use CPU-friendly validation settings
        """
    ...
    def get_evaluator(self, batch_size, is_distributed, testdev=False, legacy=False, trainset=False):
        """
        Get evaluator for CPU training
        """
