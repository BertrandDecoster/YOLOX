...
class Exp(MyExp):
    def __init__(self):
        ...
        self.depth = 0.33
        self.width = 0.375
        self.num_classes = 81  # CHANGE THIS to match your number of classes

        # Data configuration
        self.data_dir = "datasets/trashcan_test"
    ...
    def get_data_loader(
        ...
        train_loader = DataLoader(
            self.dataset, batch_size=batch_size, **dataloader_kwargs
        )
